...
function generateOpCodes(): Instruction[] {
...
async function createOpCodesHeader(opcodes: Instruction[]): Promise<void> {
  let out = ``
...
async function main(): Promise<void> {
  const codes = generateOpCodes()

  await createOpCodesHeader(codes)
