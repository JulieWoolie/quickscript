#ifndef QS_FUNCTIONSIGNATURE_H
#define QS_FUNCTIONSIGNATURE_H
...
class FunctionSignature: public ScriptType {
  ...
  public:
    ...
    static FunctionSignature* make(ScriptType* retType, bool variadic, uint32 pCount, ...);
